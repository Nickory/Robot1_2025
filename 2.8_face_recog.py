...
def process_face(img: image.Image, detect_kpu: KPU, landmark_kpu: KPU,
                feature_kpu: KPU, record_ftrs: List, feature_img: image.Image) -> Tuple[bool, Optional[str]]:
    """
    ...
    Args:
        ...
        feature_img (image.Image): Image buffer for feature extraction.
